    ...
    <span className="relative inline-flex">
      <span
        ...
        style={{
          ...
          color: textColor,
          outline: disruption
            ? `2px solid ${disruption === 'interrupted' ? 'oklch(0.577 0.245 27.325)' : 'oklch(0.75 0.183 55.934)'}`
            : undefined,
      ...
      {disruption && (
        <span
          ...
          style={{
            backgroundColor: disruption === 'interrupted' ? 'oklch(0.577 0.245 27.325)' : 'oklch(0.75 0.183 55.934)',
          }}
        />
      )}
    </span>
