...
function LineCard({
  ...
  const isRER = line.transportType === 'RER';
  ...
  return (
    ...
    >
      <span
        className={cn(
          'inline-flex items-center justify-center font-bold text-[11px] leading-none shrink-0 shadow-sm',
          isRER ? 'w-10 h-7 rounded-md' : 'w-8 h-8 rounded-full'
        )}
